                                    ...
                                    <div class="property_basic col-sm-12 col-md-12">
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="property_name" id="property_name" class="form-control" value="{{ $properties->property_name }}">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="slug" id="slug" class="form-control" value="{{ $properties->property_url }}">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="property_address col-sm-12 col-md-12">
                                        ...
                                        <div class="col-xs-6 col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="property_address1" id="property_address1" class="form-control" rows="25" placeholder="Address Line 1">{{ $properties->address1 }}</textarea>
                                            </div>
                                        </div>
