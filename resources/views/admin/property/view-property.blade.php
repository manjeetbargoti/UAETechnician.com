                        ...
                        <table id="allusers-table" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@if(!empty($property->currency)){{ $property->currency }} @endif {{ $property->property_price }}</td>
                                    <td>
                                        ...
                                        <div class="modal-content row">
                                            ...
                                            <div class="modal-body col-sm-12">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <h5><strong>Price:</strong> <span style="color: #e60f0f;">@if(!empty($property->currency)){{ $property->currency }} @endif {{ $property->property_price }}</span></h5>
