...
<script src="{{ URL::asset('frontEnd/js/slidebars.min.js') }}"></script>
<script src="{{ URL::asset('frontEnd/js/component-slidebars.min.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('frontEnd/js/jquery.fadeImg.js') }}"></script>
