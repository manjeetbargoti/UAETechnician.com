        ...
        @foreach($HeaderMenuLinks as $HeaderMenuLink)
                            ...
                            @foreach($HeaderMenuLink->webmasterSection->sections as $MnuCategory)
                                @if($MnuCategory->father_id ==0)
                                    <li class="nav-item">
                                        ...
                                        <a class="nav-link" href="{{ $Category_link_url }}">
                                            @if($MnuCategory->icon !=="")
                            ...
                            @foreach($HeaderMenuLink->webmasterSection->topics as $MnuTopic)
                                @if($MnuTopic->expire_date =='' || ($MnuTopic->expire_date !='' && $MnuTopic->expire_date >= date("Y-m-d")))
                                    <li class="nav-item">
                                        ...
                                        ?>
                                        <a class="nav-link" href="{{ $topic_link_url }}">
                                            @if($MnuTopic->icon !=="")
            ...
            @elseif($HeaderMenuLink->type==2)
                ...
                <li class="nav-item">
                    ...
                    ?>
                    <a class="nav-link" href="{{ $mmnnuu_link }}">{{ $HeaderMenuLink->$link_title_var }}</a>
                </li>
            @elseif($HeaderMenuLink->type==1)
                ...
                ?>
                <li class="nav-item"><a class="nav-link" href="{{ $this_link_url }}">{{ $HeaderMenuLink->$link_title_var }}</a></li>
            @else
                <?php
                            ...
                            @foreach($HeaderMenuLink->subMenus as $subMenu)
                                                ...
                                                @foreach($subMenu->webmasterSection->topics as $SubMnuTopic)
                                                    @if($SubMnuTopic->expire_date =='' || ($SubMnuTopic->expire_date !='' && $SubMnuTopic->expire_date >= date("Y-m-d")))
                                                        <li class="nav-item">
                                                            ...
                                                            ?>
                                                            <a class="nav-link" href="{{ $topic_link_url }}">{{$SubMnuTopic->$category_title_var}}</a>
                                                        </li>
                                                    @endif
                                                @endforeach
                                            </ul>
                                ...
                                @elseif($subMenu->type==2)
                                    ...
                                    <li class="nav-item">
                                        ...
                                        ?>
                                        <a class="nav-link" href="{{ $mmnnuu_link }}">{{ $subMenu->$link_title_var }}</a>
                                    </li>
                                @elseif($subMenu->type==1)
                                    <?php
                                    // sub menu - Direct Link
                                    ?>
                                    <li class="nav-item"><a class="nav-link" href="{{ url($subMenu->link) }}">{{ $subMenu->$link_title_var }}</a>
                                    </li>
                                @else
                                    <?php
                                    // sub menu - Main title ( have drop down menu )
                                    ?>
                                    <li class="nav-item"><a class="nav-link" href="javascript:void(0)">{{ $subMenu->$link_title_var }}</a>
                                    </li>
                                @endif
                            @endforeach
                        </ul>
