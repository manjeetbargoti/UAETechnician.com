                    ...
                    @foreach($SliderBanners as $SliderBanner)
                        <li>
							...
							<div class="banner_text">
                                @if($SliderBanner->$details_var !="")
                                    <h1>{!! $SliderBanner->$title_var !!}</h1>
                                @endif
                                @if($SliderBanner->$details_var !="")
                                    <p>{!! nl2br($SliderBanner->$details_var) !!}</p>
                                @endif
                                @if($SliderBanner->link_url !="")
                                    <p><a class="repair_btn" href="{!! $SliderBanner->link_url !!}"
                                       class="btn btn-theme">{{ trans('frontLang.moreDetails') }}</a></p>
                                @endif
                            </div>
							</div>
							</div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-6 col-md-3">
                        <div class="icon_box">
                            <span><img src="{{ URL::asset('frontEnd/images/free-delivery.svg') }}"></span>
                            <h5>FREE PICKUP AND  DELIVERY</h5>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="icon_box">
                            <span><img src="{{ URL::asset('frontEnd/images/best-price.svg') }}"></span>
                            <h5>BEST PRICE</h5>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="icon_box">
                            <span><img src="{{ URL::asset('frontEnd/images/clock.svg') }}"></span>
                            <h5>QUICK SERVICES</h5>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="icon_box">
                            <span><img src="{{ URL::asset('frontEnd/images/lace.svg') }}"></span>
