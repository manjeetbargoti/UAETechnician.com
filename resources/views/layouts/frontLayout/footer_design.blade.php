    ...
    <div class="call_sec">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="call_txt">
                        <span><img src="{{ URL::asset('images/frontend_images/images/call.svg') }}"></span>
...
<nav canvas="mobile" class="offcanvas fixed-top navbar-light mobmenu">
    ...
    <div class="row no-gutters">
        ...
        <h5 class="w-100 text-light text-truncate m-0"><a class="navbar-brand" href="#"><img width="95px" src="{{ URL::asset('images/frontend_images/images/logo.svg') }}"></a></h5>
        </div>
