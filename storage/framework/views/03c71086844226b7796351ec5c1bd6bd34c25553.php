            ...
            <div class="row">
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/mac_repair.svg')); ?>"></span>
                        <h5>MAC BOOK REPAIR / AIR / IMAC</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/laptop_repair.svg')); ?>"></span>
                        <h5>LAPTOP REPAIR SERVICES</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/computer_repair.svg')); ?>"></span>
                        <h5>COMPUTER REPAIR SERVICES</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/motherboard.svg')); ?>"></span>
                        <h5>MOTHERBOARD / LOGIC BOARD</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/window_help.svg')); ?>"></span>
                        <h5>WINDOWS HELP</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/data_recovery.svg')); ?>"></span>
                        <h5>DATA RECOVERY SOLUTION</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/tablet_repair.svg')); ?>"></span>
                        <h5>TABLET REPAIR SERVICES</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/onsite.svg')); ?>"></span>
        ...
        <p class="text-center">Simply log a request, state your IT inquiry and one of <br>
            ...
            <div class="row">
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="stepbox">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/step1.svg')); ?>"></span>
                        <h5>Call Us</h5>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="stepbox">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/step2.svg')); ?>"></span>
                        <h5>Free Pickup</h5>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="stepbox">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/step3.svg')); ?>"></span>
                        <h5>Fixing</h5>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="stepbox">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/step4.svg')); ?>"></span>
                        <h5>Testing</h5>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="stepbox">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/step5.svg')); ?>"></span>
                        <h5>Finalize</h5>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-2">
                    <div class="stepbox">
                        <span><img src="<?php echo e(URL::asset('frontEnd/images/step6.svg')); ?>"></span>
                        <h5>Free Delivery</h5>
                    </div>
                </div>
            </div>
                    ...
                    <div class="testimonials_carousel owl-carousel">
                        <div class="item">
                            <div class="testimonials_boxinn">
                                <img class="quote" src="<?php echo e(URL::to('frontEnd/images/quote-left.svg')); ?>">
                                ...
                                <div class="user_img">
                                    <img src="<?php echo e(URL::to('frontEnd/images/user.jpg')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="item">
