...
<div class="app" id="app">
    ...
    <div class="center-block w-xxl w-auto-xs p-y-md">
        ...
        <div class="p-a-md box-color r box-shadow-z1 text-color m-a">
                ...
                <div class="m-b-md">
                    <label class="md-check">
                        <input type="checkbox" name="remember"><i
                                class="primary"></i> <?php echo e(trans('backLang.keepMeSignedIn')); ?>
            ...
            <?php if(Helper::GeneralWebmasterSettings("register_status")): ?>
                ...
                <div class="text-center">
                    <a href="<?php echo e(url('/register')); ?>" class="btn info btn-block p-x-md"><i class="material-icons">&#xe7fe;</i> <?php echo e(trans('backLang.createNewAccount')); ?>
        ...
        <div class="p-v-lg text-center">
            <div class="m-b"><a href="<?php echo e(url('/password/reset')); ?>"
                                class="text-primary _600"><?php echo e(trans('backLang.forgotPassword')); ?></a></div>
        </div>
    </div>
