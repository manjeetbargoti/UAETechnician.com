        ...
        <div class="col-md-7">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Recently Added Post</h3>
            ...
            <div class="box-footer text-center">
              <a href="<?php echo e(url('/admin/properties')); ?>" class="uppercase">View All Post</a>
            </div>
            <!-- /.box-footer -->
          </div>
        </div>
...
<?php echo $__env->make('layouts.adminLayout.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\uaetechnicianne\UAETechnician.com\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>