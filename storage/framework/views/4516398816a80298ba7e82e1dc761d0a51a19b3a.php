...
<?php $__env->startSection('content'); ?>
    <div class="padding p-b-0">
        <div class="margin">
            <h5 class="m-b-0 _300"><?php echo e(trans('backLang.hi')); ?> <span class="text-primary"><?php echo e(Auth::user()->name); ?></span>, <?php echo e(trans('backLang.welcomeBack')); ?>
                                ...
                                <div class="col-xs-6">
                                    <div class="box p-a" style="cursor: pointer"
                                        ...
                                        <a href="<?php echo e(route('topics',$headerWebmasterSection->id)); ?>">
                                            ...
                                            <div class="clear">
                                                <div class="text-muted"><?php echo e(trans('backLang.'.$headerWebmasterSection->name)); ?></div>
                ...
                <div class="row-col box bg">
                    <div class="col-sm-8">
                        <div class="box-header">
                            <h3><?php echo e(trans('backLang.visitors')); ?></h3>
                            <small><?php echo e(trans('backLang.lastFor7Days')); ?></small>
                        </div>
                        <div class="box-body">
...
" style="height:162px">
                    ...
                    <div class="col-sm-4 dker">
                        <div class="box-header">
                            <h3><?php echo e(trans('backLang.reports')); ?></h3>
                        </div>
                        <div class="box-body">
                            <p class="text-muted">
                                <?php echo e(trans('backLang.reportsDetails')); ?> : <br>
                                <a href="<?php echo e(route('analytics', 'date')); ?>"><?php echo e(trans('backLang.visitorsAnalyticsBydate')); ?></a>,
                                <a href="<?php echo e(route('analytics', 'country')); ?>"><?php echo e(trans('backLang.visitorsAnalyticsByCountry')); ?></a>,
                                <a href="<?php echo e(route('analytics', 'city')); ?>"><?php echo e(trans('backLang.visitorsAnalyticsByCity')); ?></a>,
                                <a href="<?php echo e(route('analytics', 'os')); ?>"><?php echo e(trans('backLang.visitorsAnalyticsByOperatingSystem')); ?></a>,
                                <a href="<?php echo e(route('analytics', 'browser')); ?>"><?php echo e(trans('backLang.visitorsAnalyticsByBrowser')); ?></a>,
                                <a href="<?php echo e(route('analytics', 'referrer')); ?>"><?php echo e(trans('backLang.visitorsAnalyticsByReachWay')); ?></a>,
                                <a href="<?php echo e(route('analytics', 'hostname')); ?>"><?php echo e(trans('backLang.visitorsAnalyticsByHostName')); ?></a>,
                                <a href="<?php echo e(route('analytics', 'org')); ?>"><?php echo e(trans('backLang.visitorsAnalyticsByOrganization')); ?></a>
                            </p>
                            <a href="<?php echo e(route('analytics', 'date')); ?>" style="margin-bottom: 5px;"
                               class="btn btn-sm btn-outline rounded b-success"><?php echo e(trans('backLang.viewMore')); ?></a><br>
                            <a href="<?php echo e(route('visitors')); ?>"
                               class="btn btn-sm btn-outline rounded b-info"><?php echo e(trans('backLang.visitorsAnalyticsVisitorsHistory')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12 col-xl-4">
                <div class="box">
                    <div class="box-header">
                        <h3><?php echo e(trans('backLang.visitorsRate')); ?></h3>
                        <small><?php echo e(trans('backLang.visitorsRateToday')." [ ".date('Y-m-d')." ]"); ?></small>
                    </div>
                    <div class="box-body">
            ...
            <div class="col-md-12 col-xl-4">
                <div class="box" style="min-height: 300px">
                    <div class="box-header">
                        <h3><?php echo e(trans('backLang.browsers')); ?></h3>
                        <small><?php echo e(trans('backLang.browsersCalculated')); ?></small>
                    </div>
	                        ...
	                        enabled:true
                                    ...
                                    <div>
                                        ...
                                        <a href="<?php echo e(route('analytics', 'browser')); ?>"
                                           class="btn btn-sm white text-u-c rounded"><?php echo e(trans('backLang.more')); ?></a>
                                    </div>
                                </div>
                                <div class="row-cell p-a dker">
                                    <div class="inline m-b">
            ...
            <div class="col-md-12 col-xl-4">
                <div class="box light lt" style="min-height: 300px">
                    <div class="box-header">
                        <h3> <?php echo e(trans('backLang.todayByCountry')); ?></h3>
                    </div>
                    <div class="box-tool">
                        <ul class="nav">
                    ...
                    <?php if(count($TodayByCountry) == 0): ?>
                        <div class="text-center m-t-1" style="color:#bbb">
                            ...
                            <?php echo e(trans('backLang.noData')); ?></div>
                    <?php else: ?>
	                  ...
	                  <span class="w-40 rounded dker">
		                  <span><?php echo e($v1); ?></span>
		              </span>
                                        </a>
                                        <div class="list-body">
                                            <div><?php echo $flag; ?> <?php echo e($v0); ?></div>
                                            <small class="text-muted text-ellipsis">
                                                <?php echo e(trans('backLang.visitors')); ?> : <?php echo e($v2); ?>,
                                                <?php echo e(trans('backLang.pageViews')); ?> : <?php echo e($v3); ?>
                ...
                <?php if(@Auth::user()->permissionsGroup->inbox_status): ?>
                    <div class="col-md-12 col-xl-<?php echo e($col_width); ?>">
                        <div class="box m-b-0" style="min-height: 370px">
                            <div class="box-header">
                                <h3><?php echo e(trans('backLang.latestMessages')); ?></h3>
                            </div>
                            <div class="box-tool">
                                <ul class="nav">
                                    <li class="nav-item inline dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-scale pull-right">
                                            <a class="dropdown-item"
                                               href="<?php echo e(route("webmails")); ?>"> <?php echo trans('backLang.inbox'); ?> </a>
                                            <a class="dropdown-item"
                                               href="<?php echo e(route("webmails",["group_id"=>"sent"])); ?>"><?php echo trans('backLang.sent'); ?></a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
		                  ...
		                  <i class="material-icons"><?php echo $unreadIcon; ?></i>
                                ...
                                <div class="box-footer">
                                    <a href="<?php echo e(route("webmails",["group_id"=>"create"])); ?>"
                                       class="btn btn-sm btn-outline b-primary rounded text-u-c pull-right"><?php echo e(trans('backLang.compose')); ?></a>
            ...
            <?php if(Helper::GeneralWebmasterSettings("calendar_status")): ?>
                <?php if(@Auth::user()->permissionsGroup->calendar_status): ?>
                    <div class="col-md-12 col-xl-<?php echo e($col_width); ?>">
                        <div class="box m-b-0" style="min-height: 370px">
                            <div class="box-header">
                                <h3><?php echo e(trans('backLang.notesEvents')); ?></h3>
                            </div>
                            <div class="box-tool">
                                <ul class="nav">
                                    <li class="nav-item inline">
                                        <a href="<?php echo e(route("calendarCreate")); ?>"
                                           class="btn btn-sm white text-u-c rounded"><?php echo e(trans('backLang.addNew')); ?></a>
                                    </li>
                                </ul>
                            </div>
                            <div class="box-body">
                                                ...
                                                <div class="sl-content">
                                                    <div class="sl-date text-muted">
                                                        <?php if($Event->type ==1 || $Event->type ==2): ?>
                                                            <?php echo e(date('Y-m-d H:i:s', strtotime($Event->start_date))); ?>

                                                        <?php else: ?>
                                                            <?php echo e(date('Y-m-d', strtotime($Event->start_date))); ?>
            ...
            <?php if(Helper::GeneralWebmasterSettings("newsletter_status")): ?>
                <?php if(@Auth::user()->permissionsGroup->newsletter_status): ?>
                    <div class="col-md-12 col-xl-<?php echo e($col_width); ?>">
                        <div class="box m-b-0" style="min-height: 370px">
                            <div class="box-header">
                                <h3><?php echo e(trans('backLang.latestContacts')); ?></h3>
                            </div>
                            <div class="box-tool">
                                <ul class="nav">
                                    <li class="nav-item inline">
	                	...
	                	<span class="w-40 avatar">
                            <?php if($Contact->photo!=""): ?>
                                <img src="<?php echo e(URL::to('uploads/contacts/'.$Contact->photo)); ?>"
                                     alt="<?php echo e($Contact->first_name); ?> <?php echo e($Contact->last_name); ?>">
                            <?php else: ?>
                                <img src="<?php echo e(URL::to('uploads/contacts/profile.jpg')); ?>"
