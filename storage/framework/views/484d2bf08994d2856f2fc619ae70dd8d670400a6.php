    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe3c9;</i> <?php echo e(trans('backLang.editSection')); ?></h3>
                <small>
            ...
            <div class="box-body">
                    ...
                    <div class="col-sm-10">
                        <select name="father_id" id="father_id" class="form-control c-select">
                            ...
                            <?php $__currentLoopData = $FatherMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $FatherMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <option value="<?php echo e($FatherMenu->id); ?>" <?php echo e(($FatherMenu->id == $Menus->father_id) ? "selected='selected'":""); ?>><?php echo e($title); ?></option>
                ...
                <?php if(Helper::GeneralWebmasterSettings("ar_box_status")): ?>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <?php echo Form::text('title_ar',$Menus->title_ar, array('placeholder' => '','class' => 'form-control','id'=>'title_ar','required'=>'', 'dir'=>trans('backLang.rtl'))); ?>
                ...
                <?php if(Helper::GeneralWebmasterSettings("en_box_status")): ?>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <?php echo Form::text('title_en',$Menus->title_en, array('placeholder' => '','class' => 'form-control','id'=>'title_en','required'=>'', 'dir'=>trans('backLang.ltr'))); ?>
                ...
                <div id="link_div" class="form-group row" style="<?php echo e(($Menus->type ==1)? "":"display: none"); ?>">
                    ...
                    <div class="col-sm-10">
                        <?php echo Form::text('link',$Menus->link, array('placeholder' => '','class' => 'form-control','id'=>'title_ar', 'dir'=>trans('backLang.ltr'))); ?>
                    ...
                    <div class="col-sm-10">
                        <select name="cat_id" id="cat_id" class="form-control c-select">
                            ...
                            <?php $__currentLoopData = $GeneralWebmasterSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $WSection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($WSection->id); ?>" <?php echo e(($WSection->id == $Menus->cat_id) ? "selected='selected'":""); ?>><?php echo str_replace("backLang.","",trans('backLang.'.$WSection->name)); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
