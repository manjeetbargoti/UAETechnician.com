            ...
            <div class="container">
                <div class="row">
                    <div class="col-6 col-md-3">
                        <div class="icon_box">
                            <span><img src="<?php echo e(URL::asset('images/frontend_images/images/free-delivery.svg')); ?>"></span>
                            <h5>FREE PICKUP AND  DELIVERY</h5>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="icon_box">
                            <span><img src="<?php echo e(URL::asset('images/frontend_images/images/best-price.svg')); ?>"></span>
                            <h5>BEST PRICE</h5>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="icon_box">
                            <span><img src="<?php echo e(URL::asset('images/frontend_images/images/clock.svg')); ?>"></span>
                            <h5>QUICK SERVICES</h5>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="icon_box">
                            <span><img src="<?php echo e(URL::asset('images/frontend_images/images/lace.svg')); ?>"></span>
            ...
            <div class="row">
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('images/frontend_images/images/mac_repair.svg')); ?>"></span>
                        <h5>MAC BOOK REPAIR / AIR / IMAC</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('images/frontend_images/images/laptop_repair.svg')); ?>"></span>
                        <h5>LAPTOP REPAIR SERVICES</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('images/frontend_images/images/computer_repair.svg')); ?>"></span>
                        <h5>COMPUTER REPAIR SERVICES</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('images/frontend_images/images/motherboard.svg')); ?>"></span>
                        <h5>MOTHERBOARD / LOGIC BOARD</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('images/frontend_images/images/window_help.svg')); ?>"></span>
                        <h5>WINDOWS HELP</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('images/frontend_images/images/data_recovery.svg')); ?>"></span>
                        <h5>DATA RECOVERY SOLUTION</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('images/frontend_images/images/tablet_repair.svg')); ?>"></span>
                        <h5>TABLET REPAIR SERVICES</h5>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="sericon_box">
                        <span><img src="<?php echo e(URL::asset('images/frontend_images/images/onsite.svg')); ?>"></span>
        ...
        <p class="text-center">Simply log a request, state your IT inquiry and one of <br>
            ...
            <div class="howit_slide">
                <div class="owl-carousel loop">
                    <div class="item">
                        <div class="stepbox">
                            <span><img src="<?php echo e(URL::asset('images/frontend_images/images/step1.svg')); ?>"></span>
                            <h5>Get In Touch</h5>
                    ...
                    <div class="item">
                        <div class="stepbox">
                            <span><img src="<?php echo e(URL::asset('images/frontend_images/images/step2.svg')); ?>"></span>
                            <h5>Get In Touch</h5>
                            <p>Whatever your IT crisis
                                    is, call Geeks!</p>
                        </div>
                    ...
                    <div class="item">
                        <div class="stepbox">
                            <span><img src="<?php echo e(URL::asset('images/frontend_images/images/step3.svg')); ?>"></span>
                            <h5>Get In Touch</h5>
                            <p>Whatever your IT crisis
                                    is, call Geeks!</p>
                        </div>
                ...
                <div class="mackbook">
                    <img src="<?php echo e(URL::asset('images/frontend_images/images/macbook.svg')); ?>">
                </div>
            </div>
    </div>
</div>
...
<div class="experienced_work">
    <div class="container">
        <div class="row">
        <div class="col-md-6">
            <img src="<?php echo e(URL::asset('images/frontend_images/images/protection.svg')); ?>">
                    ...
                    <div class="testimonials_carousel owl-carousel">
                        <div class="item">
                            <div class="testimonials_boxinn">
                                <img class="quote" src="<?php echo e(URL::asset('images/frontend_images/images/quote-left.svg')); ?>">
                                ...
                                <div class="user_img">
                                    <img src="<?php echo e(URL::asset('images/frontend_images/images/user.jpg')); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="item">
...
<?php echo $__env->make('layouts.frontLayout.frontend_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\uaetechnicianne\UAETechnician.com\resources\views/home.blade.php ENDPATH**/ ?>