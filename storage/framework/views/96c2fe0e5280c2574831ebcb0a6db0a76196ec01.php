            ...
            <div class="modal-dialog" id="animate">
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                            ...
                                            <?php echo Form::text('date_at',date("Y-m-d H:i A", strtotime($EditEvent->start_date)), array('placeholder' => '','class' => 'form-control','id'=>'date_at')); ?>
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                                ...
                                                <?php echo Form::text('time_start',date("Y-m-d H:i A", strtotime($EditEvent->start_date)), array('placeholder' => '','class' => 'form-control','id'=>'time_start')); ?>
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                                ...
                                                <?php echo Form::text('time_end',date("Y-m-d H:i A", strtotime($EditEvent->end_date)), array('placeholder' => '','class' => 'form-control','id'=>'time_end')); ?>
            ...
            <div class="modal-dialog" id="animate">
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                            ...
                                            <?php echo Form::text('date_at',date("Y-m-d H:i A"), array('placeholder' => '','class' => 'form-control','id'=>'date_at')); ?>
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                                ...
                                                <?php echo Form::text('time_start',date("Y-m-d H:i A"), array('placeholder' => '','class' => 'form-control','id'=>'time_start')); ?>
                ...
                icons: {
                  ...
                  close: 'fa fa-remove'
                                                ...
                                                <?php echo Form::text('time_end',date("Y-m-d H:i A"), array('placeholder' => '','class' => 'form-control','id'=>'time_end')); ?>
