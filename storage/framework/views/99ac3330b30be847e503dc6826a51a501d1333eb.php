...
<i class="material-icons">&#xe7ef;</i>
                  ...
                  <span class="nav-caret">
                    ...
                    <i class="material-icons"><?php echo $LiIcon; ?></i>
                                        ...
                                        <span class="nav-text"><?php echo str_replace("backLang.","",trans('backLang.'.$GeneralWebmasterSection->name)); ?></span>
                                    </a>
                                    <ul class="nav-sub">
                                        <?php if($GeneralWebmasterSection->sections_status > 0): ?>
                                            ...
                                            <li <?php echo e(($PathCurrentFolder==$currentFolder) ? 'class=active' : ''); ?> >
                                                <a href="<?php echo e(route('sections',$GeneralWebmasterSection->id)); ?>">
                                                    <span class="nav-text"><?php echo e(trans('backLang.sectionsOf')); ?> <?php echo e(str_replace("backLang.","",trans('backLang.'.$GeneralWebmasterSection->name))); ?></span>
                                                </a>
                                            </li>
                                        <?php endif; ?>
