            ...
            <div class="col-xs-12 col-md-9">
                <div class="box box-info">
                  ...
                  <?php endif; ?>
                    <!-- /.box-header -->
                    <div class="box-body">
                      <form enctype="multipart/form-data" method="POST" action="<?php echo e(url('/admin/add-repair-service')); ?>" id="add_service" name="add_service" novalidate="novalidate">
...
<?php echo $__env->make('layouts.adminLayout.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\uaetechnicianne\UAETechnician.com\resources\views/admin/repair_services/add_repair_services.blade.php ENDPATH**/ ?>