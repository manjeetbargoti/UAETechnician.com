                    ...
                    <table class="table table-striped  b-t">
                        ...
                        <tr>
                            ...
                            <?php if($WebmasterSection->expire_date_status): ?>
                                <th class="text-center" style="width:120px;"><?php echo e(trans('backLang.expireDate')); ?></th>
                            <?php endif; ?>
                        ...
                        <?php $__currentLoopData = $Topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <?php if($WebmasterSection->expire_date_status): ?>
                                    <td class="text-center">
                                        <small <?php echo ($Topic->expire_date < date("Y-m-d"))? "style='color:red'":""; ?>><?php echo $Topic->expire_date; ?></small>
                                    </td>
                                <?php endif; ?>
                                <td class="text-center">
