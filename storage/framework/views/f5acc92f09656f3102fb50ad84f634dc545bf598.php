    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">&#xe3c9;</i> <?php echo e(trans('backLang.editPermissions')); ?></h3>
                <small>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php $__currentLoopData = $GeneralWebmasterSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $WebmasterSection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="checkbox">
                                <label class="ui-check">
                                    <?php echo Form::checkbox('data_sections[]',$WebmasterSection->id,(in_array($WebmasterSection->id,$data_sections_arr)) ? true : false, array('id' => 'data_sections'.$i)); ?>

                                    <i class="dark-white"></i><label
                                            for="data_sections<?php echo e($i); ?>"><?php echo str_replace("backLang.","",trans('backLang.'.$WebmasterSection->name)); ?></label>
                                </label>
                            </div>
                            <?php $i++; ?>
